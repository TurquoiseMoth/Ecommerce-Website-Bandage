      ...
      <div className="footer__top">
        <div className="footer__container footer__top-content">
          ...
          <div className="footer__socials">
            <a href="#facebook" aria-label="Facebook" className="footer__social-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="#instagram" aria-label="Instagram" className="footer__social-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#twitter" aria-label="Twitter" className="footer__social-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer__middle">
        <div className="footer__container footer__grid">
          ...
          <div className="footer__col">
            <h4 className="footer__col-title">Company Info</h4>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              ...
              <li><a href="#analytic">User Analytic</a></li>
          ...
          <div className="footer__col footer__col--wide">
            ...
            <span className="footer__subtext">Lore imp sum dolor Amit</span>
          </div>
